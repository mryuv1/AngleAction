...
%     energies = linspace(Ex_min, Et-EY_min, numberOfenergies);
    ...
    [t,q0_track_right_up, ~, ye1] = ode45(@(t,q)moveMentEq_PreHit(t, q, w0),tsapn, q0_right_up, opt);
    [t,q0_track_right_down, ~, ye2] = ode45(@(t,q)moveMentEq_PreHit(t, q, w0),tsapn, q0_right_down, opt);
    [t,q0_track_left_up, ~, ye3] = ode45(@(t,q)moveMentEq_PreHit(t, q, w0),tsapn, q0_left_up, opt);
    [t,q0_track_left_down, ~, ye4] = ode45(@(t,q)moveMentEq_PreHit(t, q, w0),tsapn, q0_left_down, opt);
