function Cstruct = get_fully_converted_to_Ex_coords(circle_coords, parameters)
    ...
    for w_idc = 1:length(circle_coords)
        ...
        Ey_after = Vy;
        Ex_after = Et - Ey_after;
        px_after = sqrt(2*(Ex_after - Vy));

        q0_after = [x_w; y_w; px_after; 0];
